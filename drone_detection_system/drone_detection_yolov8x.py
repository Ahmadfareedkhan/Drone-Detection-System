...
if detection_type == 'About APP':
    ...
    if image is None:
        ...
        model = torch.hub.load(r'C:\Users\HP\.vscode\drone_detection\drone_detection_system\best.pt',
    ...
    while confirm:
        ...
        try:
            ...
            model = torch.hub.load(r'C:\Users\HP\.vscode\drone_detection\drone_detection_system\best.pt', 'custom',
